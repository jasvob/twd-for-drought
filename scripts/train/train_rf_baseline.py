...
arg_parser = argparse.ArgumentParser(
    prog='Train Random Forest Baseline',
    description='Train random forest baseline and save model to file.',
)
...
if __name__ == "__main__":
    ...
    rf = RandomForestRegressor(max_depth = cfg_model['max_depth'], min_samples_leaf = cfg_model['min_samples_leaf'], n_jobs = -1,
